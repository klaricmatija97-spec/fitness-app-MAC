...
CREATE TABLE IF NOT EXISTS client_calculations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  client_id UUID NOT NULL REFERENCES clients(id) ON DELETE CASCADE,
  bmr NUMERIC NOT NULL, -- Basal Metabolic Rate
  tdee NUMERIC NOT NULL, -- Total Daily Energy Expenditure
...
CREATE TABLE IF NOT EXISTS meal_plans (
  ...
  meals JSONB NOT NULL, -- Array of daily meals with foods and quantities
...
CREATE TABLE IF NOT EXISTS training_plans (
  ...
  exercises JSONB NOT NULL, -- Array of exercises with sets, reps, rest, alternatives
...
CREATE TABLE IF NOT EXISTS workout_sessions (
  ...
  date DATE NOT NULL,
  exercises_completed JSONB NOT NULL, -- Array with completion status, notes, etc.
  calories_burned NUMERIC,
  duration_minutes INTEGER,
  watch_data JSONB, -- Data from fitness watch
