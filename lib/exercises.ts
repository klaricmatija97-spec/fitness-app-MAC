// Vježbe za teretanu i kružne treninge
...
export interface Exercise {
  ...
  type: ExerciseType;
  equipment: string; // "barbell", "dumbbell", "machine", "bodyweight", "cable", "smith"
  equipmentHr: string;
  description?: string;
  alternatives?: string[]; // IDs alternativnih vježbi
  imageUrl?: string; // URL slike sprave/vježbe
}
...
// Vježbe za kružne treninge (vlastito tijelo + tabata)
...
export function getExercisesByMuscleGroup(muscleGroup: MuscleGroup): Exercise[] {
  return gymExercises.filter(ex => ex.muscleGroup === muscleGroup);
}

export function getExerciseById(id: string): Exercise | undefined {
  return [...gymExercises, ...bodyweightExercises].find(ex => ex.id === id);
}
