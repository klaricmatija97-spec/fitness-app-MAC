...
echo Izvorište testa:
echo   1. test-supabase-connection.js (osnovni test)
echo   2. test-supabase-detailed.js (detaljni test)
echo   3. test-supabase-404-fix.js (test za STATUS 404 grešku)
echo.
echo Pokrećem TEST ZA STATUS 404...
echo.
